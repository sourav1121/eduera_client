    ...
    <Fragment>
      <Accordion open={open === 1}>
        ...
        <AccordionBody className="p-5 font-light border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900 ">
          ...
          activities, as a way to enhance the learning experience of students.
        </AccordionBody>
      </Accordion>
      <Accordion open={open === 2}>
        ...
        <AccordionBody className="p-5 font-light border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
          ...
          email (provided you’re logged into your Learnera account). You can
          also begin the course by logging in and navigating to your My learning
          page (which is not implemented yet :P).
        </AccordionBody>
      </Accordion>
